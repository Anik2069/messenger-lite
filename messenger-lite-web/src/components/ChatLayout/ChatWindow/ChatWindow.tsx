                ...
                {isImage ? (
                    ...
                    <div className="flex items-center space-x-3 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg max-w-xs">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium truncate">{fileData.originalName}</p>
        ...
        return (
            <div className="h-full flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-medium text-gray-600 dark:text-gray-400 mb-2">Select a conversation</h3>
                    <p className="text-gray-500 dark:text-gray-500">Choose a contact or group to start messaging</p>
                </div>
            </div>
        )
    }
        ...
        <div className="h-full flex flex-col">
            ...
            <div className="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 flex items-center">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        {selectedChat.type === "group" ? "Group chat" : selectedChat.isOnline ? "Online" : "Offline"}
                    </p>
                </div>
            </div>
                            ...
                            <div className="max-w-xs lg:max-w-md">
                                ...
                                >
                                    ...
                                    <div className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity flex space-x-1">
                                        ...
                                        <button onClick={() => handleForwardMessage(msg)} className="p-1 rounded hover:bg-black/10">
                                ...
                                {msg.reactions && msg.reactions.length > 0 && (
                                    <div className="flex flex-wrap gap-1 mt-1">
                                        {Object.entries(
                                            msg.reactions.reduce((acc: Record<string, string[]>, reaction) => {
                                                acc[reaction.emoji] = (acc[reaction.emoji] || []).concat(reaction.username)
                                                return acc
                                            }, {}),
                                        ).map(([emoji, users]) => (
                                            <div
            ...
            <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4">
                <form onSubmit={handleSendMessage} className="flex items-center space-x-3">
                    ...
                    <Button type="submit" disabled={!message.trim()} className="bg-blue-500 hover:bg-blue-600 text-white px-4">
