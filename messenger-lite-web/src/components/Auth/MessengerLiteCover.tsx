...
const MessengerLiteCover = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'JWT authentication and encrypted URL slugs for maximum security',
      color: 'from-purple-500 to-pink-500',
    },
    {
      icon: <Zap className="w-8 h-8 md:w-12 md:h-12" />,
      title: 'Lightning Fast',
      description: 'Built with Next.js 15 for optimal performance and scalability',
      color: 'from-orange-500 to-red-500',
    },
    {
      icon: <Upload className="w-8 h-8 md:w-12 md:h-12" />,
      title: 'File Sharing',
      description: 'Share images, PDFs, documents with dynamic attachment management',
      color: 'from-indigo-500 to-blue-500',
    },
    {
      icon: <Cloud className="w-8 h-8 md:w-12 md:h-12" />,
      title: 'Cloud Ready',
      description: 'Enterprise-grade architecture with PostgreSQL and Prisma ORM',
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex flex-wrap gap-3">
                {['Real-time Messaging', 'File Sharing', 'Group Chats', 'Mobile Responsive'].map(
                  (feature) => (
                    <div
                      key={feature}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-end">
                          <div className="bg-white rounded-lg rounded-br-none px-3 py-2 max-w-xs">
                            <div className="text-sm text-gray-800">Hey! How are you?</div>
                          </div>
                        </div>
                      </div>
                    </div>
