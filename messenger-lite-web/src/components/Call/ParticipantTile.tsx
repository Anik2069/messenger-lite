    ...
    return (
      <div className="participant-tile participant-tile--video">
        ...
        <video
          ...
          muted={isLocal}
          playsInline
          className={`w-full h-full object-center ${isCameraOff ? 'participant-tile__video--hidden' : ''}`}
        />
        ...
        <div className="participant-tile__overlay">
          <div className="participant-tile__info">
            ...
            {isMuted && <MicOff className="participant-tile__mute-icon" />}
          </div>
        </div>

        {/* Local badge */}
        {isLocal && <div className="participant-tile__local-badge">You</div>}
      </div>
    );
  }
    ...
    <div className="participant-tile participant-tile--audio">
      <div className="participant-tile__audio-content">
        ...
        <div className="participant-tile__audio-avatar-wrap">
          <div
            className={`participant-tile__audio-avatar ${!isMuted && stream ? 'participant-tile__audio-avatar--speaking' : ''}`}
          >
      ...
      <div className="participant-tile__audio-status">
        {isMuted && (
          <MicOff
            size={14}
            className="participant-tile__status-icon participant-tile__status-icon--muted"
          />
        )}
      </div>
    </div>
